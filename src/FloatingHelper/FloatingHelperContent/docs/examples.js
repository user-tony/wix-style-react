export const actionThemes = `<Layout>
  <Cell>
  <Box padding="20px" backgroundColor="D10">
...
<FloatingHelper.Content
  title='Don’t forget to setup payments'
  body='In order to sell your music you need to choose a payment method.'
  image={<Icons.Image style={{ color: 'white' }} width="102" height="102" />}
/>
</Box>
</Cell>
  <Cell>
...
<FloatingHelper.Content
  title='Don’t forget to setup payments'
  body='In order to sell your music you need to choose a payment method.'
  image={<Icons.Image width="102" height="102" />}
  appearance="light"
/>
</Box>
</Cell>
